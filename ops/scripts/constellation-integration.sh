...
NODE_OPTIONS="--max_old_space_size=16384" HARDHAT_MAX_MEMORY=16384 npx hardhat test --network optimism --no-compile "$@" --grep "CONSTELLATION: FPE Fee Payment Integration Tests"
