...
import { getChainId, sleep } from '@constellation-labs/core-utils'
import {
  CrossChainMessenger,
  MessageStatus,
  MessageDirection,
...
export class OptimismEnv {
  ...
  constructor(args: any) {
    ...
    this.L1ERC721Bridge = args.L1ERC721Bridge
    this.L1_FPE = args.L1_FPE
  }
    ...
    if (envConfig.L1_STANDARD_BRIDGE) {
      bridgeOverrides = {
        ...
        NFT: {
          ...
          l1Bridge: envConfig.L1ERC721Bridge,
    ...
    const messenger = new CrossChainMessenger({
      ...
      contracts: {
        l1: {
          ...
          L1ERC721Bridge: envConfig.L1ERC721Bridge,
