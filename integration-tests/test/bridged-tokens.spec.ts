...
import { getContractFactory } from '@constellation-labs/contracts'
...
describe('Bridged tokens', () => {
  ...
  it('should deposit tokens into L2 and grab the correct cross-chain message', async () => {
    const tx = await env.messenger.depositERC20(
      L1__ERC20.address,
      L2__ERC20.address,
      1000
    )
  ...
  withdrawalTest(
    'should withdraw tokens from L2 to the depositor and grab the correct cross-chain message',
    async () => {
