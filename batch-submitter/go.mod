...
replace github.com/ConstellationCrypto/go-ethereum-kms-signer v0.0.0 => ../go-ethereum-kms-signer

require (
	github.com/ethereum-optimism/optimism/bss-core v0.0.0
	github.com/ConstellationCrypto/go-ethereum-kms-signer v0.0.0
