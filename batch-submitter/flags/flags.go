...
var (
	...
	SequencerPrivateKeyFlag = cli.StringFlag{
		...
		EnvVar: "OVM_SEQUENCER_PRIVATE_KEY",
	}
	ProposerPrivateKeyFlag = cli.StringFlag{
		...
		EnvVar: "OVM_PROPOSER_PRIVATE_KEY",
	}

	SequencerKMSIDFlag = cli.StringFlag{
		Name:   "sequencer-kms-id",
		Usage:  "The private key to use for sending to the sequencer contract",
		EnvVar: "OVM_SEQUENCER_KMS_ID",
	}
	ProposerKMSIDFlag = cli.StringFlag{
		Name:   "proposer-kms-id",
		Usage:  "The private key to use for sending to the proposer contract",
		EnvVar: "OVM_PROPOSER_KMS_ID",
	}
