...
func Main(gitVersion string) func(ctx *cli.Context) error {
	return func(cliCtx *cli.Context) error {
		...
		sequencerPrivKey, ctcAddress, err := bsscore.ParseWalletPrivKeyAndContractAddr(
			...
			cfg.SequencerPrivateKey, cfg.SequencerKMSID, cfg.CTCAddress,
		)
		if err != nil {
			return err
		}
		...
		proposerPrivKey, sccAddress, err := bsscore.ParseWalletPrivKeyAndContractAddr(
			...
			cfg.ProposerPrivateKey, cfg.ProposerKMSID, cfg.SCCAddress,
		)
		if err != nil {
			return err
		}
