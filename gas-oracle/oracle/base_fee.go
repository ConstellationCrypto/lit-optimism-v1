...
func wrapUpdateBaseFee(l1Backend bind.ContractTransactor, l2Backend DeployContractBackend, kmsClient *kms.Client, cfg *Config) (func() error, error) {
	...
	var err error
	if cfg.kmsID != "" {
		opts, err = ethawskmssigner.NewAwsKmsTransactorWithChainID(kmsClient, cfg.kmsID, cfg.l2ChainID)
		if err != nil {
			return nil, err
		}
	} else {
