...
var (
	...
	// ErrInsufficientFPEFunds is returned if the total cost of executing a transaction
	// is higher than the balance of the user's account.
	ErrInsufficientFPEFunds = errors.New("insufficient FPE funds for gas * price + value")
