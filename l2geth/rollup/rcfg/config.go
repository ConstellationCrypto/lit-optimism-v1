...
var (
	...
	// FeeTokenSelectionSlot refers to the storage slot in the FPE_GasPriceOracle
	// that holds the fee token selection
	FeeTokenSelectionSlot = common.BigToHash(big.NewInt(5))
	// FeeTokenPriceRatioSlot refers to the storage slot in the FPE_GasPriceOracle
	// that holds the ratio of the price of the L1 token over the price of the
	// fee token
	FeeTokenPriceRatioSlot = common.BigToHash(big.NewInt(6))
	// PriceRatioDecimalsSlot refers to the storage slot in the FPE_GasPriceOracle
	// that holds the number of decimals in the ratio of the price of the L1
	// token over the price of the fee token
	PriceRatioDecimalsSlot = common.BigToHash(big.NewInt(7))
)
