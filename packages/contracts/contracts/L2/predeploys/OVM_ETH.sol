...
contract OVM_ETH is L2StandardERC20 {
    ...
    /// @notice Commented out the override on transfer because in the case that a different
    // ERC20 is used as the native token of the rollup, there will not be another way to move
    // around OVM_ETH (since the normal interface now modifies the balances of the other ERC20).
