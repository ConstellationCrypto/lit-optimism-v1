...
```solidity
import { SomeContract } from "@constellation-labs/contracts/path/to/SomeContract.sol";
```
...
```solidity
import { L1CrossDomainMessenger } from "@constellation-labs/contracts/L1/messaging/L1CrossDomainMessenger.sol";
```
