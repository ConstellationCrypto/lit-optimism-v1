...
export const DEFAULT_L2_CONTRACT_ADDRESSES: OEL2ContractsLike = {
  ...
  L2ERC721Bridge: predeploys.L2ERC721Bridge,
 ...
 * contract name.
 *
 * When adding a new L1, fill in the appropriate addresses (dependent on the address of the deployer)
 */
export const CONTRACT_ADDRESSES: {
  ...
  [L2ChainID.OPTIMISM]: {
    l1: {
      ...
      L1ERC721Bridge: '0xB7f8BC63BbcaD18155201308C8f3540b07f84F5e' as const,
    ...
    ...(CONTRACT_ADDRESSES[l2ChainId]
      ? {
          ...
          NFT: {
            ...
            l1Bridge: CONTRACT_ADDRESSES[l2ChainId].l1.L1ERC721Bridge,
